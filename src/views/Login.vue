        ...
        <div class="flex flex-col space-y-6">
          <label for="phone">
            ...
            <input id="phone" v-maska data-maska="+998(##) ###-##-##" data-maska-tokens="998"
              ...
              class="w-full py-2 border border-gray-300 dark:border-gray-600 dark:placeholder-gray-400 dark:bg-gray-900 dark:text-gray-300 rounded focus:outline-none focus:border-slate-500 hover:shadow"
          ...
          <div v-else @click="login()"
            class="w-full select-none bg-gray-900 hover:bg-gray-800 cursor-pointer py-3 font-light text-white rounded flex items-center justify-center dark:hover:bg-gray-700">
            <span>{{ $t('login') }}</span>
          </div>
