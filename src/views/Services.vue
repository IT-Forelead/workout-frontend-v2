        ...
        <div class="flex items-center space-x-3">
          <div class="relative" ref="dropdown">
            ...
            <div v-if="useModalStore().isOpenFilterBy"
              class="absolute bg-white shadow w-96 rounded-xl p-3 z-20 top-12 right-0 space-y-3 dark:bg-gray-800">
              <div>
          ...
          <div @click="useModalStore().openAddServiceModal()"
            class="bg-black text-white text-base rounded-lg p-2 px-4 cursor-pointer hover:bg-black/75 dark:bg-white dark:text-black dark:hover:bg-gray-300">
            {{ $t('addService') }}
          </div>
        </div>
      </div>
