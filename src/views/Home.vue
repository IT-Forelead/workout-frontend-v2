...
<template>
  <div class="min-h-screen px-6 py-6 dark:border-l dark:border-l-gray-600 dark:bg-gray-800">
    <div class="grid grid-cols-2 gap-x-5 mb-6 overflow-hidden">
      <div class="dark:bg-gray-900 bg-white rounded-lg">
        <div class="flex items-center justify-between p-5">
          ...
          <div class="rounded-xl p-3 bg-lime-300 dark:bg-gray-200 flex items-center justify-center">
        ...
        <div class="grid grid-cols-2 gap-x-5">
          ...
          <div class="bg-white dark:bg-gray-900 rounded-lg w-full">
            <div class="flex items-center justify-between p-5">
              <div>
                <div class="text-lg font-bold dark:text-white">{{ $t('visitStatistics') }}</div>
                <div class="text-sm dark:text-gray-200">{{ $t('statisticsForSeveralMonths') }}</div>
              </div>
              <div class="rounded-xl dark:bg-gray-200 p-3 bg-lime-300 flex items-center justify-center">
        ...
        <div class="grid grid-cols-2 gap-5">
          <div class="bg-white dark:bg-gray-900 rounded-lg w-full p-5 space-y-2">
            <div class="flex justify-between mb-3">
              ...
              <div class="rounded-xl p-3 dark:bg-gray-200 bg-lime-300 flex items-center justify-center">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg w-full p-3">
