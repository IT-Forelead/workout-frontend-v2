                    ...
                    <div class="relative" ref="dropdown">
                        ...
                        <div v-if="useModalStore().isOpenFilterBy"
                            ...
                            <div v-else @click="submitFilterData()"
                                class="w-full bg-gray-900 hover:bg-gray-800 dark:hover:bg-gray-700 cursor-pointer select-none py-3 text-white rounded-lg flex items-center justify-center">
                                <span>{{ $t('filter') }}</span>
                            </div>
                        </div>
                    </div>
                    <div @click="useModalStore().openAddSoldProdoctModal()"
                        class="bg-black text-white text-base rounded-lg p-2 px-4 cursor-pointer hover:bg-black/75 dark:bg-white dark:text-black">
                        {{ $t('addSales') }}
                    </div>
                </div>
            </div>
