    ...
    <div class="relative p-4 w-full h-full max-w-xl md:h-auto left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 border dark:border-gray-600">
        ...
        <div class="p-6 space-y-4">
          <div>
            <label class="dark:text-white">{{ $t('productName') }}</label>
          ...
          <div>
            ...
            <input v-model="submitForm.count" class="border-none text-gray-500 bg-gray-100 rounded-lg w-full text-lg dark:text-gray-300 dark:bg-gray-900 dark:placeholder-gray-400"
