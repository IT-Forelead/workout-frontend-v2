        ...
        <div class="py-4 px-6 text-center space-y-6">
          <div>
            <div class="flex items-center space-x-2">
              ...
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ selectedService?.name }}
              </div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('serviceType') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ serviceTypeTranslate(selectedService?.serviceType) }}</div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('duration') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ durationDayTranslate(selectedService?.durationDay) }}</div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('monthlyVisit') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ monthlyVisitTranslate(selectedService?.monthlyVisit) }}</div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('priceForMale') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ useMoneyFormatter(selectedService?.priceForMale) }}</div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('priceForFemale') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ useMoneyFormatter(selectedService?.priceForFemale) }}</div>
            </div>
          </div>
          <h3
