    ...
    <div class="relative p-4 w-full h-full max-w-xl md:h-auto left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 border dark:border-gray-600">
        ...
        <div class="p-6 space-y-4">
          <div>
            ...
            <div class="select-none">
              <label ref="dropdown" class="flex items-center w-full relative">
                <div class="w-11 h-11 flex items-center rounded-l-lg justify-center dark:bg-gray-900 bg-gray-100 cursor-pointer">
                  <UserIcon class="w-10 h-10 border-r dark:border-none rounded-lg p-2 dark:border-gray-600  dark:text-gray-300" />
                </div>
                <div v-if="useDropdownStore().selectCustomerOption"
                  class="border-none focus:ring-0 outline-0 bg-gray-100 w-full text-lg rounded-r-lg pl-2 py-2 capitalize dark:text-gray-300 dark:bg-gray-900 dark:placeholder-gray-400">
          ...
          <div>
            <label class="dark:text-white" for="createdAt">{{ $t('createdAt') }}</label>
          ...
          <div>
            ...
            <money3 v-model="cost" v-bind="moneyConf" id="price"
              class="border-none text-right text-gray-500 bg-gray-100 rounded-lg w-full text-lg dark:bg-gray-900 dark:text-gray-300 dark:placeholder-gray-400"> </money3>
          </div>
        </div>
