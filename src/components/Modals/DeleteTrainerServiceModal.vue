        ...
        <div class="py-4 px-6 text-center space-y-6">
          <div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('customer') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ selectedTrainerService?.trainerFirstName + ' ' +
                selectedTrainerService?.trainerLastName }}
              </div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('serviceName') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ selectedTrainerService?.name }}
              </div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('serviceType') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ serviceTypeTranslate(selectedTrainerService?.serviceType) }}</div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('duration') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ durationDayTranslate(selectedTrainerService?.durationDay) }}</div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('monthlyVisit') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ monthlyVisitTranslate(selectedTrainerService?.monthlyVisit) }}</div>
            </div>
            <div class="flex items-center space-x-2">
              <div class="text-base text-gray-500 dark:text-white">{{ $t('price') }}:</div>
              <div class="text-lg text-gray-700 dark:text-gray-300">{{ useMoneyFormatter(selectedTrainerService?.price) }}</div>
            </div>
          </div>
          <h3
