  ...
  <div class="select-none">
    <label ref="dropdown" class="flex items-center w-full relative">
      ...
      <ul v-if="useDropdownStore().isOpenVisitTypeDropDown"
        class="absolute w-full bg-white shadow rounded-b-md z-20 top-12 right-0 divide-y divide-gray-200 dark:divide-gray-600 dark:bg-gray-900 dark:text-gray-300">
